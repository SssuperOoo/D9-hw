...
#     if created:  # Проверяем, что это создание новой статьи
#         category = instance.category
#         subject = f'Новая статья в категории {category.name}'
#         message = f'Появилась новая статья в категории {category.name}. Проверьте наш сайт для прочтения.'
#         #
#         #
#         # for cat in category.all():
#         #     for sub in cat.subscribers.all():
#         #         send_mail(subject, message, 'olegnasyrov@yandex.ru', [sub.email])
#         mail_managers(
#             subject=subject,
#             message=message,
#         )
